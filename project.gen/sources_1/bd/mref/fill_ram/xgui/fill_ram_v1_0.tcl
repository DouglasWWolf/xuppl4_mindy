...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FIRST_DATA" -parent ${Page_0}
...
proc update_PARAM_VALUE.FIRST_DATA { PARAM_VALUE.FIRST_DATA } {
	# Procedure called to update FIRST_DATA when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FIRST_DATA { PARAM_VALUE.FIRST_DATA } {
	# Procedure called to validate FIRST_DATA
	return true
}
...
proc update_MODELPARAM_VALUE.FIRST_DATA { MODELPARAM_VALUE.FIRST_DATA PARAM_VALUE.FIRST_DATA } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FIRST_DATA}] ${MODELPARAM_VALUE.FIRST_DATA}
}
